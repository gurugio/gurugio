...
#include "thrsafe.h"
#include "../lockfree_mem_manager/util.h"
...
int main(void)
{
    ...
    printf("THREAD-SAFETY TEST for %s\n", global_desc.title);
    ...
    {
        printf("fail to initialize test\n");
        goto TEST_FAIL;
    }
...
#if defined(MALLOC_HOOK_DEBUG)
    printf("malloc_counter=%llu, free_counter=%llu\n",
